<template>
	<view class="uni-padding-wrap">
      ...
      <view v-if="true && 1 == 1" class="idea recommendIdea" :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"40rpx 0 20rpx","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.0)","width":"100%","borderStyle":"solid","height":"auto"}'>
      	...
      	<view class="box box4"></view>
			...
			<view class="title" :style='{"padding":"0 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
				<view :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"-120rpx 0 0 ","borderColor":"red","backgroundColor":"rgba(0, 0, 0, 0)","color":"#FFF","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"90%","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid"}'>菜品推荐</view>
			</view>
      <view v-if="true && 1 == 2" class="idea recommendIdea" :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"40rpx 0 20rpx","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.0)","width":"100%","borderStyle":"solid","height":"auto"}'>
      	<view class="box box1"></view>
      	<view class="box box2"></view>
      	<view class="box box3"></view>
      	<view class="box box4"></view>
      ...
      <view v-if="8 == 8" class="list-box style8" :style='{"padding":"20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
        <view v-if="caipinlist.length > 0" @tap="onDetailTap('caipin',caipinlist[0].id)" class="box box1" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'>
                    		                      		  		  <div v-if="true" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"24rpx","borderStyle":"solid"}' class="title hide1">{{caipinlist[0].caipinmingcheng}}</div>
		                      		                                <image :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' class="list-item-image" mode="aspectFill" :src="caipinlist[0].tupian?baseUrl+caipinlist[0].tupian.split(',')[0]:''"></image>
          		                      		                      		                      		                      		                      		                    </view>
        <view class="list-item">
          <view v-if="caipinlist.length > 1" @tap="onDetailTap('caipin',caipinlist[1].id)" class="box box2" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"140rpx"}'>
                        			                        						<div v-if="true" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"24rpx","borderStyle":"solid"}' class="title hide1">{{caipinlist[1].caipinmingcheng}}</div>
			                        			                                    <image :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' class="list-item-image" mode="aspectFill" :src="caipinlist[1].tupian?baseUrl+caipinlist[1].tupian.split(',')[0]:''"></image>
            			                        			                        			                        			                        			                        			                      </view>
          <view v-if="caipinlist.length > 2" @tap="onDetailTap('caipin',caipinlist[2].id)" class="box box3" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"160rpx"}'>
                        			                        						<div v-if="true" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"24rpx","borderStyle":"solid"}' class="title hide1">{{caipinlist[2].caipinmingcheng}}</div>
			                        			                                    <image :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' class="list-item-image" mode="aspectFill" :src="caipinlist[2].tupian?baseUrl+caipinlist[2].tupian.split(',')[0]:''"></image>
            			                        			                        			                        			                        			                        			                      </view>
          <view v-if="caipinlist.length > 3" @tap="onDetailTap('caipin',caipinlist[3].id)" class="box box4" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"180rpx"}'>
                        			                        						<div v-if="true" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"24rpx","borderStyle":"solid"}' class="title hide1">{{caipinlist[3].caipinmingcheng}}</div>
			                        			                                    <image :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' class="list-item-image" mode="aspectFill" :src="caipinlist[3].tupian?baseUrl+caipinlist[3].tupian.split(',')[0]:''"></image>
            			                        			                        			                        			                        			                        			                      </view>
        </view>
        <view class="list-item">
          <view v-if="caipinlist.length > 4" @tap="onDetailTap('caipin',caipinlist[4].id)" class="box box5" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"49%","borderStyle":"solid","height":"160rpx"}'>
                        			                        						<div v-if="true" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"24rpx","borderStyle":"solid"}' class="title hide1">{{caipinlist[4].caipinmingcheng}}</div>
			                        			                                    <image :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' class="list-item-image" mode="aspectFill" :src="caipinlist[4].tupian?baseUrl+caipinlist[4].tupian.split(',')[0]:''"></image>
            			                        			                        			                        			                        			                        			                      </view>
          <view v-if="caipinlist.length > 5" @tap="onDetailTap('caipin',caipinlist[5].id)" class="box box6" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"49%","borderStyle":"solid","height":"160rpx"}'>
                        			                        						<div v-if="true" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"24rpx","borderStyle":"solid"}' class="title hide1">{{caipinlist[5].caipinmingcheng}}</div>
			                        			                                    <image :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' class="list-item-image" mode="aspectFill" :src="caipinlist[5].tupian?baseUrl+caipinlist[5].tupian.split(',')[0]:''"></image>
            			                        			                        			                        			                        			                        			                      </view>
        </view>
      </view>
                  <view v-if="true && 1 == 3" class="idea recommendIdea" :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"40rpx 0 20rpx","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.0)","width":"100%","borderStyle":"solid","height":"auto"}'>
      	<view class="box box1"></view>
      	<view class="box box2"></view>
      	<view class="box box3"></view>
      	<view class="box box4"></view>
    ...
    <!-- 新闻资讯 -->
      ...
      <view class="title" :style='{"padding":"0 60rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"-60rpx 0 0px","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
        <view :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(0, 0, 0, 0)","color":"#FFF","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"50%","fontSize":"32rpx","lineHeight":"60rpx","borderStyle":"solid"}'>系统公告</view>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			// 推荐信息
			res = await this.$api.recommend('caipin', {                                              
                page: 1,
                limit: 4
            });
